...
] font-medium'>Home . Pages <span className='text-[#FB2E86]'>. cart</span></span>
                </div>
            </section>
                    ...
                    <div className='flex flex-col col-span-2 '>
                        ...
                        <div className='flex h-[87px] relative mt-[50px] gap-5'>
                            ...
                            <div className='h-full flex flex-col gap-2 '>
                                ...
                                <p className='text-[12px] text-[#A1A8C1] font-medium'>Color:Brown</p>
                                <p className='text-[12px] text-[#A1A8C1] font-medium'>Size:XL</p>
                            </div>
                        </div>
                        <div className='flex h-[87px] relative mt-[50px] gap-5'>
                    ...
                    <div className='flex flex-col w-fit items-center'>
                        ...
                        <div className='flex h-[87px] items-center mt-[50px] '>
                            <div className='flex w-[51px] h-[15px] bg-[#F0EFF2] text-[#BEBFC2] '>
                                <span className='h-full w-[12px] bg-[#E7E7EF] flex justify-center items-center'>-</span>
                                <span className='h-full flex-grow flex justify-center items-center'>1</span>
                                <span className='h-full w-[12px] bg-[#E7E7EF] flex justify-center items-center'>+</span>
                            </div>
                        </div>
                        <div className='flex h-[87px] items-center mt-[50px] '>
                ...
                <div className='w-full md:max-w-[371px] md:mx-auto mt-[60px] lg:mx-0 lg:mt-0'>
                    <div className='w-full flex flex-col items-center text-[#1D3178]'>
                        ...
                        <div className='w-full h-[284px] flex flex-col p-7 bg-[#E8E6F1] rounded-[3px] mt-[45px] gap-[22px]'>
                            ...
                            <p className='text-[12px] text-[#8A91AB] font-medium'>✅ Shipping & taxes calculated at checkout</p>
                    ...
                    <div className='w-full flex flex-col items-center text-[#1D3178] mt-[35px]'>
                        ...
                        <div className='w-full h-[284px] flex flex-col p-7 bg-[#E8E6F1] rounded-[3px] mt-[35px] gap-[20px]'>
                            <input className='text-[#C5CBE3] border-2 border-b-[#C5CBE3] ring-0 focus:outline-none p-2 bg-[#E8E6F1]' placeholder='Bangladesh' />
                            <input className='text-[#C5CBE3] border-2 border-b-[#C5CBE3] ring-0 focus:outline-none p-2 bg-[#E8E6F1]' placeholder='Mirpur Dhaka - 1200' />
                            <input className='text-[#C5CBE3] border-2 border-b-[#C5CBE3] ring-0 focus:outline-none p-2 bg-[#E8E6F1]' placeholder='Postal Code' />
                            <button className='rounded-[3px] text-[#ffffff] bg-[#FB2E86] w-[179px] h-[41px] font-medium '>
                                Calculate Shipping
                            </button>
                        </div>

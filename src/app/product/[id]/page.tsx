  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-between lg:flex-row gap-6 p-4 md:mt-10">
        ...
        <div className="flex-1 flex justify-center items-center shadow-xl transform transition-transform duration-300 hover:scale-105 ">
          <Image
            src={product.image}
            alt={product.name}
            width={200}
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className=" text-[#151875] text-sm ">(22)</span>
          </div>
          ...
          <Link href="/shoppingcart">
            <button className=" text-[#151875] md:px-3 md:py-4 inline-block bg-slate-300  text-[18px] family font-bold  ml-20 mt-6 hover:bg-[#e12570] hover:text-[#fff] transition-all duration-300 ease-in-out w-1/2 sm:w-1/2 text-center">
              Add to Cart 🤍
            </button>
          </Link>
        </div>

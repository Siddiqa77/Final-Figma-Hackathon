...
const HecktoDemo = () => {
  ...
  return (
    <div>
      ...
      <div className="left-[300px] top-[400px] absolute text-[#1d3178] text-2xl font-bold font-['Josefin Sans']">Hekto Demo</div> 
       <div className="left-[300px] top-[440px] absolute text-[#1d3178] text-xs font-normal font-['Lato']">Cart/ Information/ Shipping/ Payment</div>
  ...
  <div className="flex flex-col items-center md:flex-row md:items-start w-full md:w-[800px] mt-[200px]">
    <div className="flex-grow bg-[ghostwhite] rounded-[3px] py-8 px-4 sm:px-8 md:px-12">
      <div className="flex flex-wrap md:flex-nowrap items-start justify-between gap-2">
        <div className="text-blue-900 font-josefin-sans text-lg font-bold">
          Contact Information
        </div>
        <div className="flex items-center gap-2 text-sm text-[lightsteelblue] font-medium">
      ...
      <div className="mt-8">
        <button className="bg-[deeppink] text-white rounded-sm py-3 px-6 w-full sm:w-auto">
          Continue Shipping
        </button>
      </div>
    </div>

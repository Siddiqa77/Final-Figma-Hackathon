    ...
    <>
      <div className="min-h-screen py-12">
        <div className="max-w-4xl mx-auto px-4">
          <h1 className="text-4xl font-bold family text-center mb-12 text-[#1D3178]">
            Track Your Shipment
          </h1>

          <div className="bg-[ghostwhite] p-8 rounded-xl shadow-lg">
            <form
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              <div className="space-y-4">
                <label
                  htmlFor="labelId"
                  className="text-lg font-medium block text-[#1D3178]"
                >

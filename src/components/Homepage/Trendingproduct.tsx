...
<h2 className="text-3xl font-bold text-center text-[#151875] mt-16">
    ...
    <div className="container mx-auto px-4 py-10 space-y-10 mt-10 wrapper">
      {/* Top Product Grid */}
      ...
      {/* Offers Section */}
      <div className="grid grid-cols-1 md:grid-cols-2 md:grid-col-2 ">
        {/* First Offer */}
        <div className="relative bg-[#f8f9fd] rounded-md p-6 flex items-center justify-between">
          <div>
            ...
            <a href="/griddefault" className="text-pink-500 text-sm font-semibold">
              Shop Now
            </a>
          </div>
          <img

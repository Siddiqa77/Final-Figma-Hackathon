    ...
    <div>
      <div className="flex flex-col justify-between lg:flex-row gap-6 p-4">
        ...
        <div className="flex-1 space-y-4">
          <h1 className="text-xl md:text-2xl text-[#101750] font-semibold family">
            Playwood Arm Chair
          </h1>
          ...
          <div className="flex items-center space-x-4">
            ...
            <span className=" line-through text-[#151875]">$39.00</span>
          </div>
      ...
      <section className="wrapper mt-28 ">
        <div className="flex grid-row gap-28">
          <div className="text-[#151875] text-2xl font-semibold family underline">
            Description
          </div>

          <div className="w-[174px] text-[#151875] text-2xl font-semibold family">
            Additional Info
          </div>
          <div className="w-[90px] text-[#151875] text-2xl font-semibold family">
            Reviews
          </div>
          <div className="w-[66px] text-[#151875] text-2xl font-semibold family">
            Video
          </div>
        </div>
        <div className="w-52 text-[#151875] text-[22px] font-semibold family mt-16 p-2">
          Varius tempor.
        </div>
        <div className="w-[1153px] h-[87px] text-[#a9acc6] text-base font-semibold family leading-[29px]">
        ...
        <div className="w-[160px] text-[#151875] text-[22px] font-semibold family mt-12">
          More details
        </div>
        <div className="w-[1153px] h-[40px] text-[#a9acc6] text-base font-semibold family leading-[29px]">
          ➡Aliquam dis vulputate vulputate integer sagittis. Faucibus dolor
          ornare faucibus vel sed et eleifend habitasse amet. Montes, mauris
          varius ac bibendum. .
        </div>
        ...
        <h1 className=" text-[#101750] text-[28px] font-bold family mt-16 p-2">
          Related Products
        </h1>
       <div className="flex grid-row gap-5">
       <div>
          
          <img
            className="w-[270px] h-[340px] rounded-[3px]"
            src="/detailpic1.png"
          />
          <div className="w-[42px] text-[#151875] text-[13px] font-normal font-['Josefin Sans']">
            $43.00
          </div>
          <div className="w-[147px] text-[#151875] text-base font-semibold font-['Josefin Sans']">
            Mens Fashion Wear
          </div>
